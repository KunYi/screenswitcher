...
extern const MIDL_SERVER_INFO IButtonParams_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IButtonParams_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IHidManager_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IHidManager_ProxyInfo;
...
/* 40 */	0x6,		/* FC_SHORT */
	...
	/* Parameter wszButtonType */

/* 42 */	NdrFcShort( 0x148 ),	/* Flags:  in, base type, simple ref, */
...
/* 334 */	NdrFcShort( 0x36 ),	/* Type Offset=54 */
...
/* 706 */	NdrFcShort( 0x0 ),	/* 0 */
	...
	/* Parameter piButtonParams */

/* 708 */	NdrFcShort( 0xb ),	/* Flags:  must size, must free, in, */
/* 710 */	NdrFcShort( 0x4 ),	/* x86 Stack size/offset = 4 */
/* 712 */	NdrFcShort( 0x48 ),	/* Type Offset=72 */
...
/* 74 */	NdrFcLong( 0xc8b15683 ),	/* -927902077 */
/* 78 */	NdrFcShort( 0xfe3e ),	/* -450 */
/* 80 */	NdrFcShort( 0x4a49 ),	/* 19017 */
/* 82 */	0x86,		/* 134 */
			0x4b,		/* 75 */
/* 84 */	0xed,		/* 237 */
			0x9d,		/* 157 */
...
/* Object interface: IButtonParams, ver. 0.0,
   GUID={0xC8B15683,0xFE3E,0x4a49,{0x86,0x4B,0xED,0x9D,0xAA,0xA2,0x89,0x66}} */

#pragma code_seg(".orpc")
static const unsigned short IButtonParams_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IButtonParams_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IButtonParams_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IButtonParams_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(16) _IButtonParamsProxyVtbl = 
{
    &IButtonParams_ProxyInfo,
    &IID_IButtonParams,
    ...
    (void *) (INT_PTR) -1 /* IButtonParams::Initialize */ ,
    (void *) (INT_PTR) -1 /* IButtonParams::put_HIDPage */ ,
    (void *) (INT_PTR) -1 /* IButtonParams::get_HIDPage */ ,
    (void *) (INT_PTR) -1 /* IButtonParams::put_HIDUsage */ ,
    (void *) (INT_PTR) -1 /* IButtonParams::get_HIDUsage */ ,
    (void *) (INT_PTR) -1 /* IButtonParams::put_ButtonUsage */ ,
    (void *) (INT_PTR) -1 /* IButtonParams::get_ButtonUsage */ ,
    (void *) (INT_PTR) -1 /* IButtonParams::put_ButtonType */ ,
    (void *) (INT_PTR) -1 /* IButtonParams::get_ButtonType */
};


static const PRPC_STUB_FUNCTION IButtonParams_table[] =
{
...
CInterfaceStubVtbl _IButtonParamsStubVtbl =
{
    &IID_IButtonParams,
    &IButtonParams_ServerInfo,
    16,
    &IButtonParams_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};


/* Object interface: IHidManager, ver. 0.0,
   GUID={0xC1607EF3,0xCA5E,0x44bb,{0xA0,0xBC,0x18,0x22,0x46,0x70,0xDB,0x31}} */

#pragma code_seg(".orpc")
static const unsigned short IHidManager_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IHidManager_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IHidManager_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IHidManager_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(16) _IHidManagerProxyVtbl = 
{
    &IHidManager_ProxyInfo,
    &IID_IHidManager,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* (void *) (INT_PTR) -1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IHidManager::FindHidDevice */ ,
    (void *) (INT_PTR) -1 /* IHidManager::GetButtonStatus */ ,
    (void *) (INT_PTR) -1 /* IHidManager::SetButtonStatus */ ,
    (void *) (INT_PTR) -1 /* IHidManager::GetLedStatus */ ,
    (void *) (INT_PTR) -1 /* IHidManager::SetLedStatus */ ,
    (void *) (INT_PTR) -1 /* IHidManager::SetMultiLedStatus */ ,
    (void *) (INT_PTR) -1 /* IHidManager::SimulateLoopback */ ,
    (void *) (INT_PTR) -1 /* IHidManager::SimulateHidKeycode */ ,
    (void *) (INT_PTR) -1 /* IHidManager::FireOnButtonPressed */
};


static const PRPC_STUB_FUNCTION IHidManager_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IHidManagerStubVtbl =
{
    &IID_IHidManager,
    &IHidManager_ServerInfo,
    16,
    &IHidManager_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
const CInterfaceProxyVtbl * __HidManager_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IButtonParamsProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IHidManagerProxyVtbl,
    0
};

const CInterfaceStubVtbl * __HidManager_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IButtonParamsStubVtbl,
    ( CInterfaceStubVtbl *) &_IHidManagerStubVtbl,
    0
...
PCInterfaceName const __HidManager_InterfaceNamesList[] = 
{
    "IButtonParams",
    "IHidManager",
    0
...
const IID *  __HidManager_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define __HidManager_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __HidManager, pIID, n)

int __stdcall __HidManager_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( __HidManager, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( __HidManager, 2, *pIndex )
    
}

const ExtendedProxyFileInfo _HidManager_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __HidManager_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __HidManager_StubVtblList,
    (const PCInterfaceName * ) & __HidManager_InterfaceNamesList,
    (const IID ** ) & __HidManager_BaseIIDList,
    & __HidManager_IID_Lookup, 
    2,
    2,
